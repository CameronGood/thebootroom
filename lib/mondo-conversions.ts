...
const EU_TO_MONDO: { [key: number]: number } = {
  ...
  37.5: 23.0, 38: 23.5,
  38.5: 24.0, 39: 24.5,
  40: 25.0, 40.5: 25.0, 41: 25.5, 41.5: 25.5,
  42: 26.0, 42.5: 26.5,
  43: 27.0, 43.5: 27.0, 44: 27.5,
  45: 28.0, 45.5: 28.5,
  46: 29.0, 46.5: 29.0, 47: 29.5,
};
...
const UK_TO_MONDO: { [key: number]: number } = {
  ...
  4.5: 23.0, 5: 23.5,
  5.5: 24.0, 6: 24.5,
  6.5: 25.0, 7: 25.5, 7.5: 25.5,
  8: 26.0, 8.5: 26.5,
  9: 27.0, 9.5: 27.5,
  10: 28.0, 10.5: 28.5,
  11: 29.0, 11.5: 29.0, 12: 29.5,
};

const US_TO_MONDO: { [key: number]: number } = {
  3.5: 22.0, 4: 22.5,
  4.5: 23.0, 5: 23.5,
  5.5: 24.0, 6: 24.5, 6.5: 24.5,
  7: 25.0, 7.5: 25.0, 8: 25.5, 8.5: 25.5,
  9: 26.0, 9.5: 26.5,
  10: 27.0, 10.5: 27.5,
  11: 28.0, 11.5: 28.5,
  12: 29.0, 12.5: 29.0, 13: 29.5,
};
...
export function shoeSizeToMondo(
  ...
  if (system === "EU") {
    ...
    if (mondo === undefined) {
      const sizes = Object.keys(EU_TO_MONDO).map(Number).sort((a, b) => a - b);
    ...
    if (mondo === undefined) {
      const sizes = Object.keys(UK_TO_MONDO).map(Number).sort((a, b) => a - b);
      const closest = sizes.reduce((prev, curr) => 
        Math.abs(curr - value) < Math.abs(prev - value) ? curr : prev
      );
    ...
    if (mondo === undefined) {
      const sizes = Object.keys(US_TO_MONDO).map(Number).sort((a, b) => a - b);
      const closest = sizes.reduce((prev, curr) => 
        Math.abs(curr - value) < Math.abs(prev - value) ? curr : prev
      );
